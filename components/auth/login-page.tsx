...
function getLoginErrorMessage(message: string) {
  if (/email not confirmed/i.test(message)) {
    return 'Confirm your email before signing in. If you do not see the email, check your spam folder or register again.'
  }
          ...
          {showRegisteredNotice && (
            <div className="mb-5 flex items-start gap-2.5 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3">
              ...
              <p className="text-sm text-emerald-700">
                {registeredEmail
                  ? `Your account for ${registeredEmail} was created. Check your email to confirm it before signing in.`
